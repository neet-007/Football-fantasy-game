...
class Player(models.Model):
    ...
    team = models.ForeignKey(PremierLeagueTeamBase, on_delete=models.PROTECT)
    ...
    def __str__(self) -> str:
        return f'{self.last_name} {self.position} {self.team.name}'
...
class PlayerIjuriesAndBans(models.Model):
    ...
    last_name = models.CharField(max_length=255, null=True)
    team = models.ForeignKey(PremierLeagueTeamBase, on_delete=models.PROTECT)
    status = models.IntegerField(null=True, db_index=True)
